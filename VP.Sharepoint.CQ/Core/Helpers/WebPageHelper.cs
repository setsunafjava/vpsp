...
namespace VP.Sharepoint.CQ.Core.Helpers
{
    public static class WebPageHelper
    {
        ...
        public static void CreateAppWebPage(SPWeb web, string fileName, string masterUrl, bool overwrite)
        {
            CreateAppWebPage(web, fileName, masterUrl, overwrite, "Microsoft.SharePoint.WebPartPages.WebPartPage, Microsoft.SharePoint, Version=14.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c");
        }
        ...
        public static void CreateAppWebPage(SPWeb web, string fileName, string masterUrl, bool overwrite, string inherits)
        {
            var exists = web.RootFolder.Files.Cast<SPFile>().Any(file => file.Name.Equals(fileName, StringComparison.OrdinalIgnoreCase));
            ...
            var fileContent = BuildAppPageContent(inherits, masterUrl);
            var fileData = Encoding.UTF8.GetBytes(fileContent);
            CreateWebPage(web, fileName, fileData);
        }
        ...
        private static string BuildAppPageContent(string inherits, string masterUrl)
        {
            var sb = new StringBuilder();
            sb.AppendLine(string.Format(CultureInfo.InvariantCulture, "<%@ Page language=\"C#\" MasterPageFile=\"" + masterUrl + "\" Inherits=\"{0}\" meta:webpartpageexpansion=\"full\" %>", inherits));
            sb.AppendLine("<%@ Register Tagprefix=\"SharePoint\" Namespace=\"Microsoft.SharePoint.WebControls\" Assembly=\"Microsoft.SharePoint, Version=14.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c\" %>");
            ...
            sb.AppendLine("<div id=\"container_content\">");
            sb.AppendLine("<div class=\"left_content\">");
            sb.AppendLine("<WebPartPages:WebPartZone runat=\"server\" Title=\"loc:LeftUC\" ID=\"LeftUC\" FrameType=\"None\"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>");
            sb.AppendLine("</div>");
            sb.AppendLine("<div class=\"right_content\">");
            sb.AppendLine("<WebPartPages:WebPartZone runat=\"server\" Title=\"loc:RightUC\" ID=\"RightUC\" FrameType=\"None\"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>");
            sb.AppendLine("<div class=\"cleaner\"></div>");
            sb.AppendLine("</div>");
            sb.AppendLine("<div class=\"cleaner\"></div>");
            sb.AppendLine("</div>");
