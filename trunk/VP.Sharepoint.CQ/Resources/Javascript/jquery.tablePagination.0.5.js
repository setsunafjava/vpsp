 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="./ResourcesList/first.gif",
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<span id='tablePagination_perPage'> Hiển thị ");
        htmlBuffer.push("<select id='tablePagination_rowsPerPage'><option value='5'>5</option></select>");
        htmlBuffer.push(" bản ghi/trang");
        ...
        htmlBuffer.push("Trang");
        htmlBuffer.push("<input id='tablePagination_currPage' type='input' value='"+currPageNumber+"' size='1'>");
        htmlBuffer.push("của <span id='tablePagination_totalPages'>"+totalPages+"</span>");
