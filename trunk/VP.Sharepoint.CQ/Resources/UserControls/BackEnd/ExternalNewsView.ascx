...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExternalNewsView.ascx.cs" Inherits="VP.Sharepoint.CQ.UserControls.ExternalNewsView" %>
<%@ Register Tagprefix="cl" Namespace="VP.Sharepoint.CQ.Core.WebControls" Assembly="$SharePoint.Project.AssemblyFullName$" %>
<%@ Register TagPrefix="Utilities" Namespace="Microsoft.SharePoint.Utilities" Assembly="Microsoft.SharePoint, Version=14.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>

<cl:RecursiveDataView ID="viewCat" runat="server" ListName="CategoryList" ShowRibbonTabs="false" ShowTotalItems="True" MenuField="Title" 
